...
/* TODO: change argument to clarify function
...
function ww_save_post($id)
{
  ...
  // get defaults without- diabled for comparison
  ...
  if($_POST['ww-reset-widgets-to-default'] == "on" ||
     ($this_post_widgets == serialize($defaults)))
  {
